...
final class ExrCapture {
    ...
    static ExrWriter frame(GLGrab grabber, int fps, int index) {
        ...
        JSONObject frame = new JSONObject()
                .put("writer", "PUNCHStudio " + AppInfo.version + '.' + AppInfo.revision)
                .put("frame", index)
        ...
        exr.attribute("comments", "PUNCHStudio layered export. Composite in R,G,B,A; each layer under its own prefix: "
