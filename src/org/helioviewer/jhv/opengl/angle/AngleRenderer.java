...
public final class AngleRenderer {
    ...
    private static boolean edrColor = org.helioviewer.jhv.display.HdrGain.canvasEnabled();
    ...
    /**
     * The system's graphics refused ANGLE: an EGL call failed, as opposed to HelioFITS Studio being broken.
     *
