...
final class OrthographicView extends MapView {
    ...
    // Takes the mode rather than assuming Orthographic: Helioradial in 3D renders through this
    // same world-space path, and a MapView that called itself Orthographic would then answer
    // mode() with the wrong projection.
