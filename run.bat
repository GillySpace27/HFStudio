@echo off
REM PUNCHStudio 1.0.  Needs Java 25 or newer.
cd /d "%~dp0"
...
if errorlevel 1 (
    echo.
    echo PUNCHStudio needs Java 25 or newer, which was not found.
...
"%JAVA%" --enable-native-access=ALL-UNNAMED -jar PUNCHStudio.jar %*
