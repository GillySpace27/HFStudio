// normalizedMapToHelioprojective and helioprojectiveToHpcXY live in imageCommon.frag: the
// observer-sky map lays its page out the same way and reduces to the same sight-line sampling,
// so the two modes share them rather than each carrying a copy.
