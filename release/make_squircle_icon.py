#!/usr/bin/env python3
"""Build the HFStudio app icon: the sun-pie mark as full-bleed squircle art, reading HFS.
...
radial gradient fills back in, and HFS is set in the same heavy grotesque.
  ...
  python3 make_squircle_icon.py <orb.png>  ->  HFStudio_icon_squircle_1024.png + HFStudio_icon_squircle.icns
  and resources/images/HFStudio_icon_512.png, the same art for the jar's Dock, window and About icon
...
Do not pass resources/images/HFStudio_icon_512.png: that is this script's own output.
"""
